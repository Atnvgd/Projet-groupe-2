...
En cas de dégradation du QR code (sticker arraché ou trait de stylo ou autre...) l'utilisateur peut le signaler afin que l'admin puisse faire la nécessaire pour le remplacer.
